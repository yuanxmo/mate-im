...
import com.mate.im.base.utils.BeanValidator;
...
public class FacadeAspect {
    ...
    @Around("@annotation(com.mate.im.rpc.facade.Facade)")
    ...
    private Object getFailedResponse(Class returnType, Throwable throwable)
        ...
        if (returnType.getDeclaredConstructor().newInstance() instanceof BaseResponse) {
            ...
            if (throwable instanceof BizException bizException) {
                response.setResponseMessage(bizException.getExceptionCode().getMessage());
                response.setResponseCode(bizException.getExceptionCode().getCode());
            } else if (throwable instanceof SystemException systemException) {
                response.setResponseMessage(systemException.getExceptionCode().getMessage());
                response.setResponseCode(systemException.getExceptionCode().getCode());
            } else {
